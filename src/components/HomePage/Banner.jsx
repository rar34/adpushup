...
const Banner = () => {
    ...
    return (
        <div className="bg-gradient-to-t from-[#FF4854] to-[#F3295B] min-h-screen p-4 rounded-lg text-white">
            {/* logo */}
            <div className="container mx-auto p-2">
                <h2 className="text-5xl font-bold py-10 italic text-white">Adpushup</h2>
                <div className="">
                    <h2 className="text-3xl md:text-5xl space-y-3 font-bold text-white max-w-1/2">Grow your ad revenue <br /> by more than 40% with <br /> Google's Premier <br /> Certified Publishing <br /> Partner</h2>
                ...
                <button className="px-3 py-1 rounded-sm text-white bg-black font-semibold text-xl md:hidden">Setup a Demo</button>
            </div>
        </div>
    );
};
